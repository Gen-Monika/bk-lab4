...
class JobConsoleTemplateTests(TestCase):
    def test_file_results_are_not_limited_to_three_records(self):
        ...
        self.assertIn("archiveFileResultsBtn", source)
        self.assertIn("archiveRecordsBtn", source)
        self.assertIn("function archiveAllFileResults()", source)
        self.assertIn("function archiveAllRecords()", source)
