...
class JobConsoleTemplateTests(TestCase):
    def test_file_results_are_not_limited_to_three_records(self):
        ...
        self.assertNotIn("archiveFileResultsBtn", source)
        self.assertNotIn("archiveRecordsBtn", source)
        self.assertNotIn("function archiveAllFileResults()", source)
        self.assertNotIn("function archiveAllRecords()", source)
        self.assertIn("selectFileResultsBtn", source)
        self.assertIn("selectRecordsBtn", source)
        self.assertIn("selectArchivedFileResultsBtn", source)
        self.assertIn("selectUnarchivedFileResultsBtn", source)
        self.assertIn("invertFileResultSelectionBtn", source)
        self.assertIn("archiveSelectedFileResults", source)
        self.assertIn("selectArchivedRecordsBtn", source)
        self.assertIn("selectUnarchivedRecordsBtn", source)
        self.assertIn("invertRecordSelectionBtn", source)
        self.assertIn("archiveSelectedRecords", source)
