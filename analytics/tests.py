...
class AnalyticsTests(TestCase):
    ...
    def test_dashboard_renders(self):
        ...
        self.assertContains(response, "selectArchivedCounts")
        self.assertContains(response, "selectUnarchivedCounts")
        self.assertContains(response, "invertCountSelection")
        self.assertContains(response, "archiveSelectedCounts")
        self.assertContains(response, "selectArchivedEvents")
        self.assertContains(response, "selectUnarchivedEvents")
        self.assertContains(response, "invertEventSelection")
        self.assertContains(response, "archiveSelectedEvents")
        self.assertNotContains(response, "Archive All")
        self.assertNotContains(response, "Restore All")
